...
import pl.mamuti.tournament.config.audit.AuditEventConverter;
import pl.mamuti.tournament.domain.PersistentAuditEvent;
...
import static pl.mamuti.tournament.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
